    	...
    	<div class="row">
            ...
            <?php
                ...
                while($row1 = mysqli_fetch_array($check)): ?>
						...
						<form class="form-horizontal form-label-left" action="team3_edit.php?responderid=<?php echo $id; ?>" method="post" >
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-md-offset-3">
                            ...
                            <a href="team3_responder.php" class="btn btn-success"> Cancel </a>
                            <a href="team3_cp.php?responderid=<?php echo $id; ?>" class="btn btn-success"> Change Password </a>
						  ...
						  <div class="modal-dialog modal-sm">
							...
							<div class="modal-content">
							  ...
							  <div class="modal-footer">
								<a href="team3_delete.php?responderid=<?php echo $id; ?>" class="btn btn-success"> Yes </a>
                          ...
                          if(isset($_POST['save'])){
                            ...
                            $done = "UPDATE responders SET responder_firstname='$fname', responder_middlename='$mname', responder_lastname='$lname', position='$pos', Team_Number='$team', username='$username' WHERE responder_id='$id'"; 
                              if($conn->query($done) === true){
								...
								echo '<script> window.open("team3_responder.php", "_self") </script>';								
                            }
                            else{
