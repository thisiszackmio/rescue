  	...
  	if(isset($_POST['remove'])){
  		...
  		<script>
  			...
  			if(x == true){
  				...
  				?>
  				window.open("team4_responder.php","_self");
  			}else{
  				alert("Keep Going");
  			}
  		</script>
    			...
    			<div class="table-responsive">
    				<table class="table table-striped table-bordered">
			            ...
			            <?php while($row = mysqli_fetch_array($result)): ?>
		              	<tr>
			                <td> <a href="team4_edit.php?responderid=<?php echo $row['responder_id'];?>"> <?php echo $row['responder_firstname']." ".$row['responder_middlename']." ".$row['responder_lastname']; ?> </a> </td>
