    	...
    	<div class="row">
            ...
            <?php
                ...
                while($row1 = mysqli_fetch_array($check)): ?>
						...
						<form class="form-horizontal form-label-left" action="team2_edit.php?responderid=<?php echo $id; ?>" method="post" >
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-md-offset-3">
                            ...
                            <a href="team2_responder.php" class="btn btn-success"> Cancel </a>
                            <a href="team2_cp.php?responderid=<?php echo $id; ?>" class="btn btn-success"> Change Password </a>
						  ...
						  <div class="modal-dialog modal-sm">
							...
							<div class="modal-content">
							  ...
							  <div class="modal-footer">
								<a href="team2_delete.php?responderid=<?php echo $id; ?>" class="btn btn-success"> Yes </a>
