			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left" action="team3_cp.php?responderid=<?php echo $id; ?>" method="post" >
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									...
									<a href="team3_edit.php?responderid=<?php echo $id; ?>" class="btn btn-success"> Cancel </a>
								</div>
							</div>
						</form>	
					</div>
